        ...
        <div className="flex justify-between items-center">
          ...
          <ul
            className={`lg:flex lg:space-x-6 ${
              isMenuOpen
                ? 'block bg-black/75 text-white' // Transparent black background
                : 'hidden'
            } absolute lg:relative top-full left-0 right-0 shadow-md lg:shadow-none p-4 lg:p-0 mt-2 lg:mt-0 z-50`}
          >
